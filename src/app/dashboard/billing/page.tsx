...
export default function BillingPage() {
    ...
    const handleUpgrade = () => {
        ...
        if (!priceId) {
            alert("Configuration error: Missing Paddle Price ID. Please check your environment variables.");
            return;
        }
                            ...
                            <div className="relative z-10 space-y-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    <button
                                        ...
                                        disabled={!paddle}
                                        className="w-full py-2.5 px-4 bg-white text-primary font-bold rounded-full hover:bg-slate-50 transition-colors shadow-sm disabled:opacity-50"
                                    >
